...
const AboutUs = () => {
  const features = [
    {
      ...
      title: "Our Mission",
      description:
        "To revolutionize pet care through innovative digital solutions, making expert knowledge accessible to every pet owner worldwide.",
    },
    {
      icon: <Target className="w-8 h-8 text-blue-500" />,
      title: "Our Vision",
      description:
        "To become the world's most trusted pet care platform by 2025, serving millions of pet owners with reliable, personalized pet care solutions.",
    },
    {
      icon: <Award className="w-8 h-8 text-amber-500" />,
      title: "Our Values",
      description:
        "Integrity in all our interactions, excellence in service delivery, compassion for all animals, and innovation in pet care solutions.",
    },
  ];
  ...
  return (
    <div className=" ">
      {/* Hero Section */}
      <div className="  py-4 ">
        <div className=" mx-auto flex flex-col lg:flex-row items-center bg-white p-8">
          {/* Image Section */}
          ...
          <div className="lg:w-1/2 w-full lg:pl-8 text-center lg:text-left">
            ...
            <p className="text-lg">
              Dedicated to transforming pet care through innovation, compassion,
              and a commitment to quality service for all pet owners.
            </p>
          </div>
        </div>
      </div>
            ...
            <div className="space-y-4">
              <div className="flex items-center space-x-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600">
                    Founded in San Francisco with a mission to revolutionize pet
                    care
                  </p>
                </div>
              </div>
              <div className="flex items-center space-x-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600">
                    Reached 100,000 active users and launched mobile app
                  </p>
                </div>
              </div>
              <div className="flex items-center space-x-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600">
                    Expanded services nationwide and partnered with leading
                    veterinary clinics
                  </p>
                </div>
              </div>
          ...
          <div className="bg-gray-50 rounded-xl p-8">
            <ul className="space-y-4 text-gray-600">
              <li className="flex items-center space-x-3">
                ...
                <span>
                  Pet owners seeking reliable, professional pet care advice
                </span>
              </li>
              <li className="flex items-center space-x-3">
                <span className="w-2 h-2 bg-blue-600 rounded-full"></span>
                <span>
                  First-time pet parents looking for guidance and support
                </span>
              </li>
              <li className="flex items-center space-x-3">
                <span className="w-2 h-2 bg-blue-600 rounded-full"></span>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="space-y-6">
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600">
                    We begin with a thorough understanding of your pet's needs
                  </p>
                </div>
              </div>
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600">
                    Our experts create a tailored care plan for your pet
                  </p>
                </div>
              </div>
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600">
                    We help you implement the plan with ongoing support
                  </p>
                </div>
              </div>
            </div>
            <div className="bg-gray-50 p-6 rounded-lg">
              ...
              <p className="text-gray-600 mb-4">
                Every service we provide undergoes rigorous quality checks and
